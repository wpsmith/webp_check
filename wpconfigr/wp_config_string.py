"""
Read and write properties in a string in the format of a 'wp-config.py.php' file.
"""
...
class WpConfigString():
    """
    Read and write properties in a string in the format of a 'wp-config.py.php'
    file.

    Args:
        content (str): The string content of a 'wp-config.py.php' file
    """
